      ...
      statsRow = `
        ...
        <div class="halv__stats-grid">
          ...
          <div class="halv__stat-item">
            ...
            <span class="halv__stat-sub halv__red" style="font-size:14px; font-weight:800; line-height:1.3; margin-top:3px;">Queda: <span id="halv-quedatopofundo">${calcQuedaTopoFundo(h, ultimoPrecoBtc)}</span></span>
          </div>
        </div>`;
    } else if (h.topoApos) {
